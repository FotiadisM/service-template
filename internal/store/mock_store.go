...
func (_m *MockStore) WithConfiguredTX(ctx context.Context, options *sql.TxOptions, fn TxFn) error {
	ret := _m.Called(ctx, options, fn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *sql.TxOptions, TxFn) error); ok {
...
func (_c *MockStore_WithConfiguredTX_Call) Run(run func(ctx context.Context, options *sql.TxOptions, fn TxFn)) *MockStore_WithConfiguredTX_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*sql.TxOptions), args[2].(TxFn))
	})
	return _c
}
...
func (_c *MockStore_WithConfiguredTX_Call) RunAndReturn(run func(context.Context, *sql.TxOptions, TxFn) error) *MockStore_WithConfiguredTX_Call {
	_c.Call.Return(run)
	return _c
}

// WithTX provides a mock function with given fields: ctx, fn
func (_m *MockStore) WithTX(ctx context.Context, fn TxFn) error {
	ret := _m.Called(ctx, fn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, TxFn) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockStore_WithTX_Call) Run(run func(ctx context.Context, fn TxFn)) *MockStore_WithTX_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(TxFn))
	})
	return _c
}
...
func (_c *MockStore_WithTX_Call) RunAndReturn(run func(context.Context, TxFn) error) *MockStore_WithTX_Call {
	_c.Call.Return(run)
	return _c
}
